...
//        }
    ...
    private Object invokeFunctions(Object input, float[][][][] myWeight, float[] myBias, boolean destroy)
    {
        ...
        kernelHW[0]=myWeight[0][0].length;
        kernelHW[1]=myWeight[0][0][0].length;
        if (!parallel)
    ...
    //deliver some specific params to CNNdroid class
    public int[] getPad() {return pad;}
    public int[] getStride() {return stride;}
    public int [] getKernelWidthAndHeight() {return kernelHW; }
